...
export default function ProjectCard({ project }: ProjectCardProps) {
  return (
    <div className="glass-surface relative p-6 w-full border border-border rounded-lg h-full flex flex-col">
      <ProjectPreview id={project.id} name={project.companyName} src={project.companyLogoImg} imageKind={project.imageKind} />
