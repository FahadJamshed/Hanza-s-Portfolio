...
export default function BlogCard({ blog }: BlogCardProps) {
  ...
  return (
    <Link
      ...
      className="glass-surface group relative flex flex-col border border-border rounded-lg overflow-hidden h-full transition-all duration-300 hover:border-primary/40 hover:-translate-y-0.5"
    >
